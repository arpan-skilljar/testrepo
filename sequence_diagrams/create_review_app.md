...
sequenceDiagram
    ...
    aws->>aws: event bridge waits for cloudformation stack to be completed and invokes lambda
    aws->>aws: lambda updates dynamoDB table with specific reviewapp states
    aws->>github: lambda comments on PR with link to specific apps configured
